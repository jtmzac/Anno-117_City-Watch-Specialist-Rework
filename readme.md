...
In addition to the small buff, rare specialists also add an additional patrol while epic ones add the patrol and an additional buff depending on the watch type.
